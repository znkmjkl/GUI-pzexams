<div	class="navbar	navbar-inverse	navbar-fixed-top"	style="background:	rgba(0,0,0,0.85);	box-shadow:	2px	2px	20px	#444444;">
		...
		<div	class="navbar-header"	style="padding-left:	0px;">
			...
			<?php	if(isset($_SESSION['USER'])	&&	$_SESSION['USER']	!=	""){?>
				<li><a	class="navbar-brand"	href="Help.php" data-toggle='tooltip' data-placement='bottom' title='Informacje jak korzystać z serwisu'>Pomoc</a></li>
				<li><a	class="navbar-brand"	href="Contact.php" data-toggle='tooltip' data-placement='bottom' title='Kontakt z administracją'>Kontakt</a></li>
			<?php } ?>
			</ul>
			<?php
